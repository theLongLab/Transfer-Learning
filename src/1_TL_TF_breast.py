...
# # Model Train
run = wandb.init(project="TFEnformer-wandb",config={"learning_rate": 0.0001,
...
checkpoint_path="./data/ModelTraining_OldDGX/real_enformer_download/variables/variables"
...
import json
variables_files=open("./data/ModelTraining_OldDGX/DTL_202211/Enformer_all_Lvariables_matched_withindex_dict_b275.json","r")
...
checkpoint_root = "./data/ModelTraining_OldDGX/human_tfrecords_"+tissue+"/checkpoint"
...
for global_step in range(hyper_paras.train_steps): 
    ...
    #Every 256 train_steps(256 *4 samples), we check validaition and test? End of train_steps, calculate validate loss and pearsonR
